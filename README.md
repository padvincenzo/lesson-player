...
## How to update
To update ``Lesson Player`` just download the [latest version](https://github.com/padvincenzo/lesson-player/releases/latest) and copy/paste new files to your lesson player directory (replacing old files). **Do not delete the directory that contain your lessons**.
